...
// ArduinoLED.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CArduinoLEDApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CArduinoLEDApp

CArduinoLEDApp::CArduinoLEDApp()
{
...
// Единственный объект CArduinoLEDApp

CArduinoLEDApp theApp;


// Инициализация CArduinoLEDApp

BOOL CArduinoLEDApp::InitInstance()
{
